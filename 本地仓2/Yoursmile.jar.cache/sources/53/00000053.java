...
/* renamed from: com.github.catvod.spider.QQ */
/* loaded from: classes.dex */
public class C0031QQ extends Spider {

    /* renamed from: nk */
    protected JSONObject f233nk;

    /* renamed from: wd */
    protected JSONObject f234wd = new JSONObject();

    /* renamed from: KP */
    private String m1865KP(String str, String str2) {
        try {
            if (str2.startsWith("//")) {
    ...
    public String categoryContent(String str, String str2, boolean z, HashMap<String, String> hashMap) {
        ...
        try {
            ...
            String m892h = C0501Vf.m892h(str3, m1863wd(str3));
            JSONObject jSONObject = new JSONObject();
            try {
                C0479g m1242p0 = C0066e.m1746c(m892h).m1242p0(".list_item");
                JSONArray jSONArray = new JSONArray();
                for (int i = 0; i < m1242p0.size(); i++) {
                    C0321m c0321m = m1242p0.get(i);
                    String m916a = c0321m.m1242p0("a").m916a("title");
                    String m1865KP = m1865KP(str3, c0321m.m1242p0("img").m916a("src"));
                    String m913d = c0321m.m1242p0(".figure_caption") == null ? "" : c0321m.m1242p0(".figure_caption").m913d();
                    String m916a2 = c0321m.m1242p0("a").m916a("data-float");
                    JSONObject jSONObject2 = new JSONObject();
                    jSONObject2.put("vod_id", m916a2);
                    jSONObject2.put("vod_name", m916a);
                    jSONObject2.put("vod_pic", m1865KP);
                    jSONObject2.put("vod_remarks", m913d);
    ...
    public String detailContent(List<String> list) {
        ...
        try {
            ...
            JSONObject jSONObject = new JSONObject(C0501Vf.m892h(str, m1863wd(str)));
            ...
            jSONObject2.put("vod_pic", m1865KP(str, optJSONObject.optString("pic")));
            ...
            JSONArray jSONArray2 = optJSONObject.getJSONArray("video_ids");
            ArrayList arrayList2 = new ArrayList();
            ArrayList arrayList3 = new ArrayList();
            int i2 = 1;
            while (i2 <= jSONArray2.length()) {
                arrayList2.add(jSONArray2.optString(i2 - 1));
                String str2 = "https://union.video.qq.com/fcgi-bin/data?otype=json&tid=682&appid=20001238&appkey=6c03bbe9658448a4&union_platform=1&idlist=" + join(charSequence2, arrayList2);
                JSONArray jSONArray3 = new JSONObject(C0501Vf.m892h(str2, m1863wd(str2)).substring(13, m892h.length() - 1)).getJSONArray("results");
                int i3 = 0;
                while (i3 < jSONArray3.length()) {
                    JSONObject jSONObject3 = jSONArray3.getJSONObject(i3).getJSONObject("fields");
    ...
    public String homeContent(boolean z) {
        try {
            ...
            JSONObject jSONObject = new JSONObject();
            if (z) {
                jSONObject.put("filters", this.f233nk);
            }
            jSONObject.put("class", jSONArray);
            try {
                C0479g m1242p0 = C0066e.m1746c(C0501Vf.m892h("https://v.qq.com/x/bu/pagesheet/list?_all=1&append=1&channel=choice", m1863wd("https://v.qq.com/x/bu/pagesheet/list?_all=1&append=1&channel=choice"))).m1242p0(".list_item");
                JSONArray jSONArray2 = new JSONArray();
                int min = Math.min(m1242p0.size(), 20);
                for (int i = 0; i < min; i++) {
                    C0321m c0321m = m1242p0.get(i);
                    String m916a = c0321m.m1242p0("a").m916a("title");
                    String m1865KP = m1865KP("https://v.qq.com/x/bu/pagesheet/list?_all=1&append=1&channel=choice", c0321m.m1242p0("img").m916a("src"));
                    String m913d = c0321m.m1242p0(".figure_caption").m913d();
                    String m916a2 = c0321m.m1242p0("a").m916a("data-float");
                    JSONObject jSONObject2 = new JSONObject();
                    jSONObject2.put("vod_id", m916a2);
                    jSONObject2.put("vod_name", m916a);
    ...
    public String homeVideoContent() {
        try {
            JSONArray jSONArray = new JSONObject(C0501Vf.m892h("https://v.qq.com/api.php/app/index_video?token=", m1863wd("https://v.qq.com/api.php/app/index_video?token="))).getJSONArray("list");
            JSONArray jSONArray2 = new JSONArray();
    ...
    public String searchContent(String str, boolean z) {
        try {
            ...
            JSONArray jSONArray = new JSONObject(C0501Vf.m892h(str2, m1863wd(str2))).getJSONArray("uiData");
            JSONArray jSONArray2 = new JSONArray();
            for (int i = 0; i < jSONArray.length(); i++) {
    ...
    /* renamed from: wd */
    protected HashMap<String, String> m1863wd(String str) {
