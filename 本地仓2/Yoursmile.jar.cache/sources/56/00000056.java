...
public class SP360 extends Spider {
    ...
    /* renamed from: ue */
    protected JSONObject f237ue = null;
    ...
    public String categoryContent(String str, String str2, boolean z, HashMap<String, String> hashMap) {
        ...
        try {
            ...
            JSONObject jSONObject = new JSONObject(C0501Vf.m892h(str6, m1858ue())).getJSONObject("data");
    ...
    */
    ...
    public String homeContent(boolean z) {
        ...
        try {
            jSONObject.put("class", this.f237ue.getJSONArray("classes"));
            if (z) {
                jSONObject.put("filters", this.f237ue.getJSONObject("filter"));
            }
    ...
    public String homeVideoContent() {
        JSONObject jSONObject = new JSONObject();
        try {
            String m892h = C0501Vf.m892h("https://api.web.360kan.com/v1/rank?cat=1", new HashMap());
            SpiderDebug.log("响应请求：https://api.web.360kan.com/v1/rank?cat=1");
            JSONArray optJSONArray = new JSONObject(m892h).optJSONArray("data");
    ...
    public String searchContent(String str, boolean z) {
        ...
        JSONObject jSONObject = new JSONObject();
        try {
            JSONObject optJSONObject2 = new JSONObject(C0501Vf.m892h(String.format("https://api.so.360kan.com/index?force_v=1&kw=%s&from=&pageno=1&v_ap=1&tab=all", str), m1858ue())).optJSONObject("data");
    ...
    /* renamed from: ue */
    protected HashMap<String, String> m1858ue() {
